...
const defaultOrigins = [
  'https://braj-darshan-wdw9.onrender.com',
  'https://braj-mandel-admin.vercel.app',
  'http://localhost:3000',
  'http://localhost:5173',
  'http://localhost:4173',
];
...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type','Authorization','x-request-id','X-API-Key','x-admin-api-key','X-CSRF-Token'],
  credentials: true,
}));
